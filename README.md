...
describe() is what is being tested, and it() is an individual test.

1. What is the point of `Test Driven Development`? What do you think about this approach?

The point of Test Driven Development is to reduce the risk of regressions and minimize the number of bugs that may appear in the creation of the product.  

1. Mention three types of automated tests.

end to end / unit testing / itergration testing
